...
var createElements = function createElements(elementsArray) {
  return elementsArray.map(function (config) {
    ...
    // create main element
    var element = createElement(tag, attributes, content);
...
} `, "",{"version":3,"sources":["webpack://./src/css/main.css"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,gBAAA;EACA,iBAAA;EACA,iBAAA;EACA,gCAAA;EACA,yBAAA;AACF;;AAEA;EACE,sBAAA;EACA,SAAA;EACA,UAAA;AACF;;AAEA;EACE,gBAAA;EACA,kCAAA;AACF;;AAEA;EACE,kCAAA;AACF;;AAEA;EACE,WAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;EACA,6BAAA;EACA,mBAAA;EACA,iCAAA;EACA,+BAAA;AACF","sourcesContent":[":root {\n  --clr-light-gray: #eee;\n  --clr-gray: #ddd;\n  --clr-white: #fff;\n  --clr-black: #000;\n  --clr-shadow: rgba(0, 0, 0, 0.6);\n  --clr-light-blue: #468d99;\n}\n\n* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\nhtml {\n  font-size: 62.5%;\n  font-family: \"Poppins\", sans-serif;\n}\n\nbody {\n  background-color: var(--clr-white);\n}\n\n.header-container {\n  width: 100%;\n  height: 12em;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n  align-items: center;\n  background-color: var(--clr-gray);\n  border-bottom-left-radius: 30px;\n}/*# sourceMappingURL=main.css.map */"],"sourceRoot":""}]);
// Exports
