    ...
    if (_headerControls__WEBPACK_IMPORTED_MODULE_1__.header) {
      ...
      switch (newBreakpoint) {
        ...
        case 'm':
          ...
          _headerControls__WEBPACK_IMPORTED_MODULE_1__.header.style.display = 'none'; // Hide the header
          break;
        case 's':
          console.log('sScreen is set');
          _headerControls__WEBPACK_IMPORTED_MODULE_1__.header.style.display = 'flex'; // Show the header
...
var setupListeners = function setupListeners() {
  Object.values(breakpoints).forEach(function (query) {
